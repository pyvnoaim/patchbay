// Generates ui/brands.js — the OS/appliance glyphs for a jack's `os = "..."`.
...
console.log(`wrote ui/brands.js (${Object.keys(brands).length} marks, ${Object.keys(FALLBACKS).length} fallbacks)`);
